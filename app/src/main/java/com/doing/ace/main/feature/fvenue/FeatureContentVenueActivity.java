package com.doing.ace.main.feature.fvenue;
...
public class FeatureContentVenueActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feature_content_venue);

        initViews();
    }

    private void initViews() {
        viewPager = findViewById(R.id.feature_fvenue_vp);
        tabLayout = findViewById(R.id.feature_fvenue_tl);
        ...
        listView = findViewById(R.id.feature_fvenue_gv);
        List<FeatureContentVenueBean> list = new ArrayList<>();
        list.add(new FeatureContentVenueBean());
        list.add(new FeatureContentVenueBean());
        list.add(new FeatureContentVenueBean());
        list.add(new FeatureContentVenueBean());
        list.add(new FeatureContentVenueBean());
        FeatureContentVenueGVAdapter gymCoachGVAdapter = new FeatureContentVenueGVAdapter(this,
                list);
    ...
    public void backFeatureFVenue(View view) {
        finish();
    }
}
