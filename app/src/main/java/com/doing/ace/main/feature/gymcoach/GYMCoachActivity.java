...
import com.doing.ace.main.feature.coach.StarCoachListAdapter;
...
public class GYMCoachActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gymcoach);
        initViews();
    }

    private void initViews() {
        viewPager = findViewById(R.id.gym_coach_vp);
        tabLayout = findViewById(R.id.gym_coach_tl);
        ...
        listView = findViewById(R.id.gym_coach_gv);
    ...
    public void backGymCoach(View view) {
        finish();
    }
}
