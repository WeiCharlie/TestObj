...
public class FeatureVenueActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feature_venue);
        initViews();
    }
    private void initViews() {
        viewPager = findViewById(R.id.feature_venue_vp);
        tabLayout = findViewById(R.id.feature_venue_tl);
        ...
        listView = findViewById(R.id.feature_venue_gv);
    ...
    public void backFeatureVenue(View view) {
        finish();
    }
}
