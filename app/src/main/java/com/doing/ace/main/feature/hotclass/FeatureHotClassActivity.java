...
public class FeatureHotClassActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feature_hot_class);

        initViews();
    }

    private void initViews() {
        viewPager = findViewById(R.id.feature_hot_class_vp);
        tabLayout = findViewById(R.id.feature_hot_class_tl);
        ...
        listView = findViewById(R.id.feature_hot_class_gv);
        List<FeatureHotClassBean> list = new ArrayList<>();
        list.add(new FeatureHotClassBean());
        list.add(new FeatureHotClassBean());
        list.add(new FeatureHotClassBean());
        list.add(new FeatureHotClassBean());
        list.add(new FeatureHotClassBean());
        FeatureHotClassGVAdapter gymCoachGVAdapter = new FeatureHotClassGVAdapter(this,
                list);
    ...
    public void backFeatureHotClass(View view) {
        finish();
    }
}
